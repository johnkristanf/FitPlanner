...
export const MealsModal = ({ value, closeMealModal}: any) => {
    ...
    return(
        ...
        <>   
            ...
            <div key={value.mealcontents.title} className="absolute m-auto z-50 bg-slate-700 px-5 py-16 
                                                           rounded-md text-white w-1/2 h-2/3 max-sm:w-4/5 max-sm:h-2/4
                                                           max-md:w-4/5 max-md:h-2/4" 

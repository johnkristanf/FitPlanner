           ...
           <div className="pb-2">
            ...
            <div className='flex justify-start flex-wrap w-4/5 absolute top-40 pl-3 gap-16' style={{right: '-5%'}}>
                ...
                { 
                    !Meals ?
                      ...
                      <>
                        <div className='flex flex-col ml-10 mt-3 max-md:ml-[-20%] items-start'>
                              ...
                              <button onClick={() => setViewCustomMeals(true)} className='mt-7 max-md:ml-[-20%] max-md:mt-[-10%] max-md:self-auto max-md:w-1/2 self-end bg-orange-500 h-1/2 text-white p-2 rounded-md hover:opacity-75'>
                                  View Custom Meals
                              </button>
                    ...
                    : <div className='flex flex-col w-11/12 max-md:ml-[-10%]'>

                        <div className='flex max-md:flex-col max-md:ml-[-10%] gap-28'>

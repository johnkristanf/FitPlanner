                    ...
                    !Meals ?
                      ...
                      <>
                        <div className='flex flex-col ml-10 mt-3 max-md:ml-[-20%] items-start'>
                              ...
                              <button onClick={() => setViewCustomMeals(true)} className='mt-5 max-md:ml-[-20%] max-md:mt-[-10%] max-md:self-auto max-md:w-1/2 self-end bg-orange-500 h-1/2 text-white p-2 rounded-md hover:opacity-75'>
                                  View Custom Meals
                              </button>

...
export const DisplayCustomMeals = ({ closeModal }: any) => {
    ...
    <>
            ...
            <div className="absolute max-md:left-[-10%] flex max-sm:flex-col max-sm:w-full max-sm:mt-10 max-md:flex-col justify-center w-full top-24 bottom-0 right-0 left-0 m-auto gap-10" style={{ zIndex: 600 }}>

                {
                    
                    SortedCustomMealPlans.map((plan: CustomMealPlansType) => (

                        <div key={plan._id} className="w-1/4 h-full max-sm:w-full max-md:w-full bg-gray-300 p-5 rounded-md mt-10">

...
export const DisplayCustomMeals = ({ closeModal }: any) => {
    ...
    <>
            ...
            <div className="fixed flex max-sm:flex-col max-sm:w-full max-sm:mt-8 justify-center w-full top-24 bottom-0 right-0 left-5 m-auto gap-10" style={{ zIndex: 600 }}>

                {
                    
                    SortedCustomMealPlans.map((plan: CustomMealPlansType) => (

                        <div key={plan._id} className="w-1/4 h-1/4 bg-gray-300 p-5 rounded-md mt-10">
